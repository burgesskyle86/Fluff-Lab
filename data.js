const FLUFF_DATA = {
  ...
  genericIngredients: {
    ...
    strawberries: { id:"strawberries", name:"Strawberries", category:"fruits", purpose:"Fruit flavor and volume.", effects:["Fresh fruit flavor", "More moisture", "Pairs well with cheesecake"], bestRange:"1/2 to 1 cup" },
    blueberries: { id:"blueberries", name:"Blueberries", category:"fruits", purpose:"Fruit flavor and color.", effects:["Berry flavor", "Softer texture after chilling", "Pairs well with vanilla"], bestRange:"1/2 to 1 cup" },
    banana: { id:"banana", name:"Banana", category:"fruits", purpose:"Fruit sweetness and banana flavor.", effects:["Sweeter", "Creamier", "Stronger banana flavor over time"], bestRange:"1/2 to 1 banana" },
    thin_chocolate_cookie: { id:"thin_chocolate_cookie", name:"Thin Chocolate Sandwich Cookie", category:"additive", purpose:"Crunch and chocolate cookie flavor.", effects:["Crunch", "Dessert flavor", "Softens after chilling"], bestRange:"1 to 3 cookies" },
    graham_cracker: { id:"graham_cracker", name:"Graham Cracker", category:"additive", purpose:"Pie crust flavor and crunch.", effects:["Crust flavor", "Crunch", "Softens into cheesecake-like texture"], bestRange:"1/2 to 1 sheet" },
  ...
  formulas: [
    ...
    },
    {
      ...
      procedure:["Add yogurt and whipped topping to the mixing bowl and mix until evenly combined.","Add whey, pudding mix, and acacia fiber to the mixing bowl and mix.","Mix until smooth and slightly fluffy.","Add vanilla extract and fold gently.","Refrigerate at least 15–30 minutes, or over night."]
    },
    {
      ...
      procedure:["Add yogurt and whipped topping to the mixing bowl and mix until evenly combined.","Add whey, cheesecake pudding, and acacia fiber to the mixing bowl and mix.","Mix until smooth and thick.","Fold in blueberries.","Refrigerate at least 15–30 minutes, or over night."]
    },
    {
      ...
      procedure:["Add yogurt and whipped topping to the mixing bowl and mix until evenly combined.","Add chocolate whey, chocolate pudding, and acacia fiber to the mixing bowl and mix.","Mix until smooth and fluffy.","Refrigerate at least 15–30 minutes, or over night."]
    },
    {
      ...
      procedure:["Add yogurt and whipped topping to the mixing bowl and mix until evenly combined.","Add vanilla whey, vanilla pudding, and acacia fiber to the mixing bowl and mix.","Mix until smooth.","Fold in thin chocolate sandwich cookies last.","Refrigerate at least 15–30 minutes, or over night."]
    },
    {
      ...
      procedure:["Add yogurt and whipped topping to the mixing bowl and mix until evenly combined.","Add whey, cheesecake pudding, and acacia fiber to the mixing bowl and mix.","Mix until smooth.","Fold in key lime juice.","Add graham cracker near the end.","Refrigerate at least 15–30 minutes, or over night."]
    },
    {
      ...
      procedure:["Add yogurt and whipped topping to the mixing bowl and mix until evenly combined.","Add whey, cheesecake pudding, and acacia fiber to the mixing bowl and mix.","Mix until smooth.","Add lemon juice and fold gently.","Refrigerate at least 15–30 minutes, or over night."]
    },
    {
      ...
      ingredients:[amt("plain_protein_yogurt",1,[0.25, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2],"base"),amt("chocolate_whey",1,[0.25, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2],"base"),amt("chocolate_pudding",1,[0.25, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2],"base"),amt("whipped_topping",2,[0, 0.25, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2, 2.25, 2.50, 2.75, 3, 3.25, 3.50, 3.75, 4],"additive"),amt("acacia_fiber",1,[0, 0.25, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2],"additive")],
      procedure:["Add yogurt and whipped topping to the mixing bowl and mix until evenly combined.","Add chocolate whey, chocolate pudding, and acacia fiber to the mixing bowl and mix.","Add your peanut butter and mix until smooth and thick.","Refrigerate at least 15–30 minutes, or over night."]
    },
    {
      ...
      procedure:["Add yogurt and whipped topping to the mixing bowl and mix until evenly combined.","Add whey, cheesecake pudding, and acacia fiber to the mixing bowl and mix.","Mix until smooth and thick.","Fold in strawberries.","Refrigerate at least 15–30 minutes, or over night."]
    },
    {
      ...
      procedure:["Add yogurt and whipped topping to the mixing bowl and mix until evenly combined.","Add vanilla whey, vanilla pudding, and acacia fiber to the mixing bowl and mix.","Mix until smooth.","Add vanilla extract and fold gently.","Refrigerate at least 15–30 minutes, or over night."]
    }
